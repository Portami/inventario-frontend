import {deleteProduct, fetchProducts} from '@/features/products/api';
...
import ExpandableDataGrid, {ExpandableDataGridRow} from '@/features/products/components/ExpandableDataGrid';
