import {changeOfferState, fetchOffer} from '@/features/offers/api';
import CreateOfferDialog from '@/features/offers/components/create/CreateOfferDialog';
import BulkStateDialog from '@/features/offers/components/list/BulkStateDialog';
import CustomerCell from '@/features/offers/components/list/CustomerCell';
import DueCell from '@/features/offers/components/list/DueCell';
import FilterBar, {DateRange, SortOption} from '@/features/offers/components/list/FilterBar';
import InventoryCell from '@/features/offers/components/list/InventoryCell';
import StateChip from '@/features/offers/components/list/StateChip';
import {daysFromNow, fmtCHF, fmtDate, OFFER_STATE, OFFER_STATE_META, PAGE_SIZE} from '@/features/offers/constants';
