...
import type {CustomerWithIdDto} from '@/features/customers/types';
import {createOffer, fetchFeltCatalog, fetchProductCatalog} from '@/features/offers/api';
...
import KindChip from '@/features/offers/components/list/KindChip';
import {CUT_SURCHARGE_DEFAULT, LINE_KIND, RESERVATION_KIND} from '@/features/offers/constants';
import {BackendCreateOfferItemDto, FeltCatalogItem, LineItemDto, ProductCatalogItem} from '@/features/offers/types';
