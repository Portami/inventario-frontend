import {DEFAULT_LABEL_HEIGHT_MM, DEFAULT_LABEL_WIDTH_MM} from '../constants';
import LabelDimensionControls from '@/features/labels/components/LabelDimensionControls';
import LabelsPreview from '@/features/labels/components/LabelsPreview';
import ProductSelectionTable from '@/features/labels/components/ProductSelectionTable';
import {generateLabelsPDF} from '@/features/labels/labelPdfService';
import {Product} from '@/features/products/types';
import {fetchRolls} from '@/features/rolls';
...
const toProduct = (roll: FeltRollDto): Product => ({
    ...
    length: roll.length * 10,
    width: roll.width * 10,
    feltTypeName: roll.feltTypeName,
