        ...
        <Box sx={{display: 'flex'}}>
            ...
            >
                ...
                <List component={'nav'}>
                    ...
                    <ListItem disableGutters>
                        <Button component={NavLink} to={'/lager'} startIcon={<HomeOutlinedIcon />} sx={{justifyContent: 'flex-start', width: '100%'}}>
                            Lager
                        </Button>
                    </ListItem>
                    <ListItem disableGutters>
                ...
                <Box sx={{flexGrow: 1}} />
                <Button startIcon={<SettingsIcon />} sx={{justifyContent: 'flex-start', width: '100%'}}>
                    Settings
                </Button>
                <Button startIcon={<LogoutIcon />} sx={{mt: 2, justifyContent: 'flex-start', width: '100%'}}>
                    Logout
                </Button>
            </Drawer>
            <Container>
